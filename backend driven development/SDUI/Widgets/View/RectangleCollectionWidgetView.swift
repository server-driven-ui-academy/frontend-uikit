//
//  RectangleCollectionWidgetView.swift
...
class RectangleCollectionWidgetView: UIStackView {
    private let widget: RectangleCollectionWidget
    ...
    let collection: UICollectionView = {
        let itemSize = CGSize(width: 100, height: 124)
        ...
        collection.register(SmallItemCollectionViewCell.self, forCellWithReuseIdentifier: SmallItemCollectionViewCell.identifier)
        
        return collection
    }()
    
    init(widget: RectangleCollectionWidget, delegate: ActionDelegate) {
        self.widget = widget
...
//MARK: - ViewCodable
extension RectangleCollectionWidgetView: ViewCodable {
...
extension RectangleCollectionWidgetView: UICollectionViewDataSource, UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return widget.list.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: SmallItemCollectionViewCell.identifier, for: indexPath) as! SmallItemCollectionViewCell
